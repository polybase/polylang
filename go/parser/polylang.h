...
char *validate_set_decorators(const char *program_ast_json, const char *collection_name, const char *data_json, const char *previous_data_json, const char *public_key);
